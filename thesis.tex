...
%% Updated by Utkarsh Nath for MS Thesis in 2020-2021
...
% \documentclass[12pt,letterpaper]{polythesis}
...
\newcommand{\graddate}{May 20XX} % like January XX, May 20XX, September 20XX

%% If you do not want a dedication, scroll down and comment out
%% the appropriate lines in this file.
\newcommand{\thesisdedication}{To all frontline COVID-19 workers}
...
\noindent
University ID: \underline{....}\\ % Add your University ID
Net ID: \hspace{.415in} \underline{....}\\ % Add your Net ID
...
\bibliography{thesis} % add intelligently
